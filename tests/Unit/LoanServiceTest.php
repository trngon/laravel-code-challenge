...
class LoanServiceTest extends TestCase
{
    ...
    public function testServiceCanCreateLoanOfForACustomer()
    {
        ...
        $this->assertDatabaseHas('scheduled_repayments', [
            'loan_id' => $loan->id,
            'amount' => 1668,//1666 + 1666 + 1667 = 4999 => This test case is wrong
            'outstanding_amount' => 1668,//Same for here
            'currency_code' => $currencyCode,
            'due_date' => '2020-04-20',
            'status' => ScheduledRepayment::STATUS_DUE,
        ]);
    ...
    public function testServiceCanRepayAScheduledRepayment()
    {
        ...
        $scheduledRepaymentThree =  ScheduledRepayment::factory()->create([
            'loan_id' => $loan->id,
            'amount' => 1668, //Total amount must be 5000
            'currency_code' => Loan::CURRENCY_VND,
            'due_date' => '2020-04-20',
        ]);
    ...
    public function testServiceCanRepayAScheduledRepaymentConsecutively()
    {
        ...
        $scheduledRepaymentThree =  ScheduledRepayment::factory()->create([
            'loan_id' => $loan->id,
            'amount' => 1668,//to be sure total amount is 5000
            'currency_code' => Loan::CURRENCY_VND,
            'due_date' => '2020-04-20',
            'status' => ScheduledRepayment::STATUS_DUE,
        ]);

        $receivedRepayment = 1668;//to be sure total amount is 5000
        $currencyCode = Loan::CURRENCY_VND;
        ...
        $this->assertDatabaseHas('scheduled_repayments', [
            ...
            'outstanding_amount' => 0,
            'currency_code' => $currencyCode,
            'due_date' => '2020-04-20',//The last due must be 2020-04-20
            'status' => ScheduledRepayment::STATUS_REPAID,
        ]);
    ...
    public function testServiceCanRepayMultipleScheduledRepayments()
    {
        ...
        $this->assertDatabaseHas('scheduled_repayments', [
            'id' => $scheduledRepaymentOne->id,
            'loan_id' => $loan->id,
            'amount' => 1666,//The first repayment we set 1666
            'outstanding_amount' => 0,
            'currency_code' => $currencyCode,
            'due_date' => '2020-02-20',
            'status' => ScheduledRepayment::STATUS_REPAID,
        ...
        $this->assertDatabaseHas('scheduled_repayments', [
            'id' => $scheduledRepaymentTwo->id,
            'loan_id' => $loan->id,
            'amount' => 1666,//The second repayment we set 1666
            'outstanding_amount' => 1332, // 2000 - 1667 ===> This calculation is wrong 1666 - (2000 - 1666) = 1332
            'currency_code' => $currencyCode,
            'due_date' => '2020-03-20',
